...
<head>
    ...
    <script type="text/javascript">
        ...
        function change_login() {
            document.getElementById("CLimg").src = "${pageContext.request.contextPath}/checkImg?time="
                + new Date().getTime();
        }
        function change_Register(){
            document.getElementById("CRimg").src = "${pageContext.request.contextPath}/checkImg?time="
                + new Date().getTime();
        }
        function findProductById(id){
            location.href="http://localhost:8084/ProductFindByIdServlet?id="+id;
        }
        function showck(obj) {
            location.href="http://localhost:8084/ProductFindByPageCodeServlet?code="+obj;
        }
        function tocart() {
            location.href="http://localhost:8084/showcart.jsp";
        }
        function tosearch(){
            location.href="http://localhost:8084/showProducts.jsp";
        }
    </script>
</head>
<body>
...
<header>
    <nav class="navbar navbar-inverse" role="navigation">
        ...
        <a href="javascript:void(0)" onclick="tosearch()">搜索</a>
                ...
                <div class="group-inputs">
                    ...
                    <div class="captcha input-wrapper" data-type="en">
                        ...
                        <img class="captcha-img" data-toggle="tooltip" data-placement="top" title="看不清楚？换一张"
                             alt="验证码" src="${pageContext.request.contextPath}/checkImg" id="CLimg" onclick="change_login()">
                    </div>
                </div>
                <div class="sign-btn">
                ...
                <div class="group-inputs">
                    ...
                    <div class="captcha input-wrapper" data-type="en">
                        <input id="captcha-1" name="captcha" placeholder="验证码" required="" data-rule-required="true"
                               data-msg-required="请填写验证码">
                        <img class="captcha-img" data-toggle="tooltip" data-placement="top" title="看不清楚？换一张"
                             alt="验证码" src="${pageContext.request.contextPath}/checkImg" id="CRimg" onclick="change_Register()">
...
<aside class="aside-tool">
    <ul>
        <li class="customer">
            <a href="http://wpa.qq.com/msgrd?v=3&uin=1372076247&site=qq&menu=yes" target=_blank
