...
<script type="text/javascript">
    ...
    //*2.************点击+ —  实现对商品数量的操作id是商品的id，count,是要改变的数量.数量有增有减，对数据的边界进行操作
                ...
                <div class="group-inputs">
                    ...
                    <div class="captcha input-wrapper" data-type="en">
                        ...
                        <img class="captcha-img" data-toggle="tooltip" data-placement="top" title="看不清楚？换一张"
                             alt="验证码" src="${pageContext.request.contextPath}/checkImg" id="Checkimg" onclick="change_login()">
                    </div>
                </div>
                <div class="sign-btn">
...
<aside class="aside-tool">
    <ul>
        <li class="customer">
            <a href="http://wpa.qq.com/msgrd?v=3&uin=1&site=1372076247&menu=yes" target=_blank
