...
<head>
    ...
    <script type="text/javascript">
        ...
        function findProductById(id){
            location.href="${pageContext.request.contextPath}/ProductFindByIdServlet?id="+id;
        };
        function phone(obj) {
            ...
            <form id="sign-form-2" action="${pageContext.request.contextPath}/RegistServlet" method="post">
                <div class="group-inputs">
                    ...
                    <div class="captcha input-wrapper" data-type="en">
                        ...
                        <span> ${requestScope["regist.message"]} </span>
                    </div>
                </div>
                <div class="sign-btn">
...
<aside class="aside-tool">
    <ul>
        <li class="customer">
            <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=1372076247&site=qq&menu=yes">联系客服</a>
        </li>
        <li class="top"></li>
    </ul>
</aside>
